...
class CustomException(Exception):
    def __init__(self, error_massge,error_detail:sys):
        super().__init__(error_massge)
        self.error_massage = error_massage_detail(error_massge,error_detail=error_detail)
